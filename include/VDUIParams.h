...
namespace videodromm {
	...
	private:
		...
		unsigned	uiLargeH = (previewFboHeight + uiMargin) * 6;
		...
		unsigned	uiXPosCol3 = uiXPosCol2 * 3 + uiMargin;
	...
	public:
		...
		VDUIParams()
		{
			...
			uiLargeH = (previewFboHeight + uiMargin) * 6;
			...
			uiXPosCol3 = uiXPosCol2 * 3 + uiMargin;
